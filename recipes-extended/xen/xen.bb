...
FILES_${PN}-xenstored-c = " \
    ...
    /etc/init.d/xenstored.xen-xenstored-c \
...
pkg_postinst_${PN}-xenstored-c () {
    update-alternatives --install ${sbindir}/xenstored xenstored xenstored.${PN}-xenstored-c 50
    update-alternatives --install /etc/init.d/xenstored xenstored-initscript xenstored.${PN}-xenstored-c 50
}
